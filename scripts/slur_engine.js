function Insult() {
	...
	insult3 = ["apple-john","baggage","barnacle","bladder","blind-worm","blumpkin","boar-pig","bugbear","bum-bailey","canker-bloss","clack-dish","clotpole","codpiece","coxcomb","cur","death-token","devil-monk","dewberry","donkey","eater of broken meats","flap-dragon","flax-wench","flirt-gill","fool","foot-licker","fustilarian","giglet","gudgeon","haggard","harpy","hedge-pig","horn-beast","hugger-mugge","joithead","jolt-head","knave","lewdster","lickspittle","lout","maggot-pie","malcontent","malt-worm","mammet","measle","minnow","miscreant","moldwarp","mumble-news","ninnycock","nut-hook","peasant","pigeon-egg","pignut","plague-rat","popinjay","pumpion","puttock","quim","ratsbane","rogue","ruffian","scullian","scut","skainsmate","strumpet","varlot","vassal","villain","wagtail","whey-face","wretch"];
